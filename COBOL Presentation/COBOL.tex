...
\begin{columns}%[b]{.40\textwidth}
	\begin{column}{5cm}
		\includegraphics{CobolCogLogo}\\ %\hspace{1.5pt}
		\includegraphics[width=5cm]{GnuCOBOLLogoTransparent}
	\end{column}
%\end{columns}
%\begin{columns}%[b]{.60\textwidth}
	\begin{column}{5cm}
		\includegraphics[width=2.5cm]{DOSMSCOBOL45}
...
\begin{frame}{Versionen des Standards}
	\begin{itemize}
		...
		\item
			COBOL 1985: \"uberarbeiteter ANSI Standard, Einf\"uhrung G\"ultigkeitsbereich-Terminatoren (z.B. \texttt{END-IF}), neue Features geschachtelte Unterprogramme, neue Statements, die Operatoren >= und <=; ersetzen von selbstmodifizierenden Code über \texttt{ALTER} durch Referenz Modifikation
	\end{itemize}
\end{frame}
...
\begin{frame}{heutiger Einsatz}
	\begin{itemize}
		...
		\item
			2009 geschätzt \"uber 40 Milliarden Zeilen COBOL Code in Industrieprogrammen verwendet, Wachstumsrate 4 Milliarden Zeilen Code pro Jahr
	\end{itemize}
\end{frame}
...
\begin{frame}{Sprachspezifikation}
	\begin{itemize}
		...
		\item
			Standard Kontrollstrukturen: \texttt{IF...THEN...ELSE}, 
	\end{itemize}
\end{frame}
