...
\begin{frame}{Anfänge}
  ...
  \item
    Offizielle Festlegung des Standards (bekannt als COBOL 60) am 03. Januar 1960, danach individuelle (inkompatibele) Erweiterungen durch verschiedene Firmen und Universitäten
  \end{itemize}
\end{frame}
