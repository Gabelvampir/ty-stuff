...
versteckte Dateien an, -l gibt auch Attribute wie Größe und Leserechte
aus
...
\item nethack - eines der ältesten rogue-likes
\end{itemize}

\section*{Was tun wenn der X-Server ohne Konfiguration nicht startet?}
\begin{enumerate}
\item Herrausfinden was für eine Grafikkarte der Rechner der Rechner hat:
lspci | grep VGA
...
integriert, X-Server Teil des Treibers in Paket xserver-xorg-video-intel)
\end{itemize}
