...
\mode<presentation>
{
  ...
  %\usetheme{Madrid}
  %\usetheme{Luebeck}
  \usetheme{Frankfurt}  %favorite for now
  %\usetheme{Dresden}
  %\usetheme{Copenhagen}
  %\usetheme{Berlin}
  %\usetheme{Warsaw}
...
\begin{frame}{Konzeptplanung}
Nix
\end{frame}

\begin{frame}{Konzeptplanung2}
Nix
\end{frame}
...
%		\mcc{4}{Kosten für die Einrichtung}\\
		\hline
		Kosten-	&	 &	\centering CommuniGate- &	\\
		Kategorie	&	Projekt &	\centering Upgrade &	Status Quo\\
		\hline
...
%		\mcc{4}{Jährliche Kosten}\\
		\hline
		Kosten-	&	 &	CommuniGate- &	\\
		Kategorie	&	Projekt &	Upgrade &	Status Quo\\
		\hline
		Hardware &	0,00\euro{} &	0,00\euro{} &	0,00\euro{}\\
		\hline
